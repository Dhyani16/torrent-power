  ...
  def energy_charges
    puts("HTMD 3")
      puts("Note: The Billing Demand will be taken as under:
          ...
          Contract Demand means the maximum kW for the supply of which TPL has provided facility to the consumer.
